  ...
  return (
    <section className="bg-charcoal text-on-inverse mt-10 md:mt-14">
      <div className="container mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Link
          href="/courses"
          className="glow-on-hover group inline-flex items-center gap-3 rounded-full bg-on-inverse py-2 pl-5 pr-2 text-inverse shadow-inverse hover:shadow-glow-hover hover:-translate-y-0.5"
        >
