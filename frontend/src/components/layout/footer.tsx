...
export function Footer({ settings }: { settings: SiteSettings | null }) {
  ...
  return (
    <footer className="border-t border-border mt-20 pb-16 md:pb-0">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <Link href="/" className="flex items-center gap-3 group w-fit">
              <KolosLogo size={24} className="text-text" />
          ...
          {hasContacts && (
            <div>
              <h3 className="text-sm font-semibold text-text mb-3 uppercase tracking-wide">Контакты</h3>
          ...
          {hasSocial && (
            <div>
              <h3 className="text-sm font-semibold text-text mb-3 uppercase tracking-wide">Мы в соцсетях</h3>
