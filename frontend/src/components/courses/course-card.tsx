      ...
      <Card className="group overflow-hidden p-0 h-full">
        <div className="relative aspect-video overflow-hidden bg-surface-2">
          ...
          <div className="absolute bottom-4 left-4">
            <span className="inline-block rounded-full bg-inverse px-3 py-1 text-sm font-semibold text-on-inverse">
              {formatPrice(course.price)}
            </span>
          </div>
        </div>
        <CardContent className="p-5">
          <h3 className="font-semibold text-lg mb-2 group-hover:text-muted transition-colors line-clamp-2">
            {course.title}
          </h3>
